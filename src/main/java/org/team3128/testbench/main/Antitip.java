...
import edu.wpi.first.networktables.NetworkTableEntry;
import edu.wpi.first.networktables.NetworkTableInstance;
public class Antitip extends NarwhalRobot {
    AHRS ahrs;
    ...
    //Float Theta=ahrs.getRoll();
        if(Theta>ThetaThreshold){
            boi1.set(ControlMode.PercentOutput,Theta);
            boi2.set(ControlMode.PercentOutput,Theta);
        }
    }
    ...
    public static void main(String[] args) {
        RobotBase.startRobot(Antitip::new);
    }
